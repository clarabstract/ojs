...
Element.addMethods({
  ...
  readAttribute: Element.Methods.readAttribute.wrap(
    function(proceed, element, attrib_name) {
      var attrib = proceed(element, attrib_name);
      // IE returns the crazyest attribs...
      if(typeof(attrib)=="string") return attrib;
    }
  )
})
